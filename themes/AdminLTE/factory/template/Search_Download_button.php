...
$cur_time = time();
$excel = new ExportDataExcel('file','./resource/report/'.$cur_time.'_Report.xls');
        ...
        <form class="form-horizontal" action="<?php echo $home . '/' . $module . '/' . $controller . '/' . $method; ?>" method="post">
            ...
            <div class="row hidden-print">
                ...
                <div class="col-md-2 col-xs-10 text-right">
                    ...
                    <!--<input tabindex="2" class="btn btn-info margin" type="submit" name="exact_search" value="Exact Search">-->
                                    ...
                                    <tr role="row">
                                        ...
                                        <th width="50px">S.No</th>
                                            ...
                                            if(!$ID_column_required){
                                                ...
                                                $excel->initialize();
                                                $title=array("  Stock Issue Report ");
                                                //$excel->addRow($title); 
                                                $a1=array("S.No");
                                                $a2=$table_columns_label_arr;
                             ...
                             ?>
                                <tbody >
                                    ...
                                    <tr class="table-striped" role="row" >
                                            ...
                                            <td class="hidden-print"><input style="width: 20px;" type="radio" name ="ycs_ID" value="<?php echo $sql_data_value[0]; ?>"></td>
                                            <td><?php echo $sno = ($key+1)+($results_per_page*($current_page-1));
                                                      $s_no = array($sno);
                                                     ?></td>
                                            <?php
                                            ...
                                            if(!$ID_column_required){
                                             ...
                                             $excel->addRow(array_merge($s_no,$sql_data_value));
