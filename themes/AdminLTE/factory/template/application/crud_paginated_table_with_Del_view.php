        ...
        <form class="form-horizontal" action="<?php echo $home . '/' . $module . '/' . $controller . '/' . $method; ?>" method="post">
            ...
            <div class="row hidden-print">
                ...
                <div class="col-md-4 col-xs-8 text-right">
                        ...
                        <?php if (!$update_form) : ?><a href="<?php echo $home . '/' . $module . '/' . $controller . '/' . 'entry'; ?>"><input style="margin-right: 10px; margin-left: 10px" class="btn btn-info" type="button" name = "req_from_list_view" value="Add"></a><?php endif; ?>
                    <?php if ($wp): ?>
                        <input style="margin-right: 10px; margin-left: 10px" class="btn btn-info" type="submit" name = "req_from_list_view" value="Delete">  
                        <input style="margin-right: 10px; margin-left: 10px" class="btn btn-info" type="submit" name = "req_from_list_view" value="Incentives">  
                    <?php endif; ?>
                    <input style="margin-right: 10px; margin-left: 10px" class="btn btn-info" type="submit" name= "req_from_list_view" value="View Invoice"> 
                </div>
            </div>
                            ...
                            <table aria-describedby="example1_info" role="grid" id="example1" class="table table-bordered table-striped dataTable table-responsive">
                                ...
                                <tbody>
                                    <tr class="odd hidden-print">
                                        <td colspan="2"> <input style="width: 80px" class="btn btn-primary btn-sm" name="clr" value="Clear" type="button" onclick="ManageQueryFilter('<?php echo $tableName_wo_prefix; ?>','<?php echo $home; ?>','<?php echo $name; ?>','clear')"></td>
