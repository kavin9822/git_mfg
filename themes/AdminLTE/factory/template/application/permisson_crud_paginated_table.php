        ...
        <form class="form-horizontal" action="<?php echo $home . '/' . $module . '/' . $controller . '/' . $method; ?>" method="post">
            ...
            <div class="row hidden-print">
                ...
                <div class="col-md-4 col-xs-8 text-right">
                    ...
                    <?php if ($wp): ?>
                        <input style="margin-right: 10px; margin-left: 10px;" class="btn btn-info" type="submit" name = "req_from_list_view" value="Add-Permission">
                        <input style="margin-right: 10px; margin-left: 10px" class="btn btn-info" type="submit" name = "req_from_list_view" value="Re-Generate" onclick ="if(!confirm('Are you sure !\nYou want to regenerate the permissions\nThis will reset all the permisson')){return false;}">  
                        <?php endif; ?>
