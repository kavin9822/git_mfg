    ...
    <div class="box-header">
        ...
        <form class="form-horizontal" id="crud_form" action="<?php echo $home . '/' . $module . '/' . $controller . '/' . $method; ?>" method="post">
            ...
            <div class="row hidden-print">
                <div class="col-md-4 hidden-xs"><?php if(isset($widget_1)){echo $widget_1;} ?></div>
                <div class="col-md-4 col-xs-4"><?php if(isset($widget_2)){echo $widget_2;} ?></div>
                <div class="col-md-4 col-xs-7 text-right">
                    <!--<button class="btn btn-info margin" name="search" id="search_btn" onclick="ManageQueryFilter('<?php echo $tableName_wo_prefix; ?>','<?php echo $home; ?>','','search')">Search</button>-->
                    <input  class="btn btn-info margin" name="search" value="Search" type="button" id="search_btn" onclick="ManageQueryFilter('<?php echo $tableName_wo_prefix; ?>','<?php echo $home; ?>','0','search')">
                            ...
                            <table aria-describedby="example1_info" role="grid" id="example1"  class="table table-bordered table-striped dataTable table-responsive">
                                    ...
                                    <tr role="row">
                                        ...
                                        <th width="50px">S.No</th>
                                            ...
                                            foreach ($table_columns as $tab_columns) :
                                                ?>
                                            <th aria-label="Rendering engine: activate to sort column descending" aria-sort="ascending" style="width: 100px;" colspan="1" rowspan="1" aria-controls="example1" tabindex="0" class="sorting_asc">
                                                <?php
                                ...
                                <tbody   >
                                    ...
                                    <?php if(empty($sql_data_rows)){ ?>
                                            <tr><td colspan="<?php echo count($table_columns)+1; ?>"><h3 style="color:red;" class="text-center">No records found!</h3><td><tr>
                                    <?php } ?>
                                    ...
                                    <tr class="<?php if(isset($cls)){echo $cls;} ?>" role="row" >
                                            ...
                                            foreach ($sql_data_value as $sql_Key => $sql_value) :
                                                ...
                                                if( !empty($FKEY) && $FKEY == $sql_Key): ?>
                                                  ...
                                                  <?php elseif(!empty($FKEY2) &&  $FKEY2 == $sql_Key ): ?> 
                                                    <td><?php if(array_key_exists($sql_value,$FKEYVAL2)){echo $FKEYVAL2[$sql_value] . '('.$sql_value.')' ;} ?></td>     
