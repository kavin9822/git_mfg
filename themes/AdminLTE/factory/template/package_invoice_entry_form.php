    ...
    <form class="form-horizontal" id="crud_form" action="<?php echo $home . '/' . $module . '/' . $controller . '/' . $method; ?>/submit/" method="post">  
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" name="InvoiceType" id="InvoiceType" value="Package" type="text"  readonly >
                    </div>
                </div>
                    ...
                    <tbody id="invoice_listing_table">
                        ...
                        <tr id="Invoice_data_entry_1">
                            ...
                            <td>
                                <div class="form-group">
                                    <div class="col-sm-10">
                                        ...
                                        <select class="form-control" name="PackageId_1" id="PackageId_1"  onchange="$('#Amount_1').val($('#PackageId_1').find(':selected').data('id'))">
                                            <?php foreach ($package_data as $pc_opt_value): ?>
                                                <option  value="<?php echo $pc_opt_value['ID']; ?>" data-id = "<?php echo $pc_opt_value['Amount']; ?>"><?php echo $pc_opt_value['Plan']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <td>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <input class="form-control" id="StartDate_1" name="StartDate_1" value="" placeholder="Start Date" type="date">
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <input class="form-control" id="EndDate_1" name="EndDate_1" value="" placeholder="End Date" type="date">
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <input class="form-control btn-primary" id="ADD" name="ADD" value="+"  type="button" onclick="addRow_pac()">
                                    </div>
                                </div>
                            </td>
                        </tr>
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                ...
                <button type ="submit" class="btn btn-success pull-right" onmouseover="subtotal_pac()" onfocus="subtotal_pac()"><i class="fa fa-credit-card"></i> Submit Payment</button>
            </div>
        </div>
    </form>
