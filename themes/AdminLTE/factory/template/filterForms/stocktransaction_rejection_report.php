    ...
    <div class="row" >
		...
		<div class="form-group">
                       ...
                       <?php if(isset($FmData[0]['product_ID'])) { ?>
                              ...
                              <?php }else { ?>
					          <select class="form-control" name="product_ID" id="product_ID" onchange="Fetch_rejection_report_Data(this.value,'Subcontractor_ID')" >
							  <?php } ?>
		...
		<div class="col-sm-6">	
		<div class="form-group">
                       <label  class="col-sm-3 control-label">Emp/Subcontractor Name</label>
			           <div class="col-sm-9">
