    ...
    <div class="box-header">
        ...
        <form class="form-horizontal" action="<?php echo $home . '/' . $module . '/' . $controller . '/' . $method; ?>" method="post">
            ...
            <div class="row hidden-print">
				...
				<label class="col-sm-8 control-label">Store</label>
				<div class="col-sm-4">
				<!-- <input class="form-control" id="pono" name="pono" value="<?php echo $FmData[0]['PONo'];?>" type="text" readonly>		 -->
                <select class="form-control js-example-basic-single" name="po_no" id="po_no"  onmouseover="ycssel()" >
            ...
            <input class="btn btn-info margin" id="workorder_no" name="workorder_no" value="ADD Stock Transfer" type="text" style="margin-right: 100%;" >
