<section class="invoice">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" name="PurchaseOrderNo" id="PurchaseOrderNo" onchange="$('#BatchNo').val($('#PurchaseOrderNo').find(':selected').data('batchno'));getPODetails('<?php echo $home; ?>',this.value);">
    ...
    <!--    </div> --><!-- /.row -->
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                <a href="<?php echo $home . '/' . $module . '/' . $controller . '/manage'; ?>" class="btn btn-default btn-primary margin" ><i class="fa fa-list"></i> List PPC</a>
