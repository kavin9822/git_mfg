...
class Form_Elements {
    ...
    public static function data($reg, $form_data = NULL) {
        ...
        $FormConfig = array(
            ...
            'table_name' => 'PurchaseRequestMaster',
            /*
            ...
            'form_content' => array(
                ...
                'PurchaseRequestNo' => array(
                    'filter' => TRUE,
                    'type' => 'text',
                    'value' => $form_data['PurchaseRequestNo'],
                    'label' => 'PurchaseRequest No',
                   
                ),
                
                'PurchaseRequestDate' => array(
                    'filter' => TRUE,
                    'type' => 'text',
                    'value' => $form_data['PurchaseRequestDate'],
                    'label' => 'PurchaseRequestDate',
                    
                ),
                'PurchaseRequestTime' => array(
                    'filter' => TRUE,
                    'type' => 'text',
                    'value' => $form_data['PurchaseRequestTime'],
                    'label' => 'PurchaseRequestTime'
                ),
                'Area' => array(
                    'filter' => TRUE,
                    'type' => 'text',
