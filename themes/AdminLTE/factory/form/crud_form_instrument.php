           ...
           // 'uniq_key_col' => 'InstrumentCode',
            ...
            'form_content' => array(
                ...
                'InstrumentCode' => array(
                    'filter' => TRUE,
                    'type' => 'text',
                    'value' => $form_data['InstrumentCode'],
                    'label' => 'Instrument Code'
                ),
                'InstrumentName' => array(
                    'filter' => TRUE,
                    'type' => 'text',
                    'value' => $form_data['InstrumentName'],
                    'label' => 'Instrument Name',
                    'status'=>'required'
                ),
                'InstrumentRange' => array(
                    'filter' => TRUE,
                    'type' => 'text',
                    'value' => $form_data['InstrumentRange'],
