...
class Form_Elements {
    ...
    public static function data($reg, $form_data = NULL) {
		...
		'users_ID' => array(
                ...
                'StockPurchased' => array(
                    'filter' => TRUE,
                    'type' => 'number',
                    'value' => $form_data['StockPurchased'],
                    'label' => 'Stock Purchased'
                ),
                'StockSold' => array(
                    'filter' => TRUE,
                    'type' => 'number',
                    'value' => $form_data['StockSold'],
                    'label' => 'Stock Sold'
                ),                 
                'AvailableStock' => array(
                    'type' => 'number',
                    'value' => $form_data['AvailableStock'],
                    'label' => 'Entity',
                ),                             
                'TotalAmountPurchase' => array(
                    'type' => 'number',
                    'value' => $form_data['TotalAmountPurchase'],
                    'label' => 'Total Amount Purchase'
                ),
                'TotalAmountSold' => array(
                    'type' => 'number',
                    'value' => $form_data['TotalAmountSold'],
