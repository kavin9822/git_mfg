            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <select class="form-control js-example-basic-single" name="dc_ID" id="dc_ID" onchange="getdeliverychallandetails('<?php echo $home; ?>',this.value);getdcproduct('<?php echo $home; ?>',this.id);" onmouseover="ycssel()">
                              <option value="" disabled selected style="display:none;">Select</option>
                                    <?php foreach ($deliverychallan_data as  $k => $v):
                                     if ($v['ID'] == $FmData[0]['dc_ID']) {
                                        $isselected = 'selected="selected"';
                    ...
                    <tbody id="invoice_listing_table">
                         ...
                         <tr id="Invoice_data_entry_<?php echo $tii; ?>">
                             ...
                             <td>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                      ...
                                      <input class="form-control" id="Amount_<?php echo $tii; ?>" name="Amount_<?php echo $tii; ?>" value="<?php if($dataValue['ReceivedQuantity']){ echo $dataValue['ReceivedQuantity']; } ?>" onkeyup="pendingqty(this.id,'please enter quantity within in DC Quantity')"  placeholder="Received Quantity" type="text" >
                            ...
                            <td>                                      
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <input class="form-control" type="text" id="Amount_1" name="Amount_1" value="" placeholder="Received Qty"  onkeyup="pendingqty(this.id,'please enter quantity within in DC Quantity')" style="text-align:right;" >
