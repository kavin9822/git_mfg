...
class Form_Elements {
    ...
    public static function data($reg, $form_data = NULL) {
        ...
        $FormConfig = array(
             ...
             */
            'Max_number_columns_in_data_grid' => 5,
            /*
             * Title of the Page
             */
            'page_title' => 'Admin',
             ...
             */
            'form_title' => 'Add Permissions Form',
            /*
            ...
            'Custom_crud_paginated_table_complete_path'=>'factory/template/application/permisson_crud_paginated_table.php',
            /*
