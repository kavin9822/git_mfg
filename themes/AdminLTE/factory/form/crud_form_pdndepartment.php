    ...
    public static function data($reg, $form_data = NULL) {
        ...
        $FormConfig = array(
          ...
          //  'unique_key_suffix_from_column_name' => 'Country',
             ...
             */
            'form_title' => 'Production Department Master',
            /*
            ...
            'DeptName' => array(
                    'filter' => TRUE,
                    'type' => 'text',
                    'value' => $form_data['DeptName'],
                    'label' => 'Production Department',
                    'status'=>'required onblur="Fetch_duplicate_production_department_Data('."this.value,'pdndepartment','DeptName','DeptName'".')"'
            ...
            'Description' => array(
                    ...
                    'label' => 'Description',
                    'status'=>'onblur="Fetch_duplicate_production_department1_Data('."this.value,'pdndepartment','Description','Description'".')"'
            ),
            'entity_ID' => array(
                    'type' => 'hidden',
