...
///////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            $u_SGServerIP = $ses->get('entity_data')[0]['SGServerIP'];
...
/////////////////////////////////////////////////////////////////////////////////////////////////////    
      ...
      $plan_table = $crg->get('table_prefix') . 'plan';
      $entityID = $ses->get('entity_data')[0]['ID'];
      $sqlplan = "SELECT `ID`, `Title` FROM `$plan_table` WHERE `entity_ID` = $entityID"; 
      $plan_ID_sel = $dbutil->getSqlData($sqlplan, 12);
        ...
        $FormConfig = array(
             ...
             * or colun name
             */
            'unique_key_suffix_from_pac_sa' => $ses->get('entity_data')[0]['ShortCode'],
            /*
             * Form limit 
             ...
             * Title of the Page
             */
            'page_title' => 'Entity wise',
            /*
             * Can also be the tite of the List data table
             */
            'form_title' => 'Package Creation',
            /*
            ...
            'form_content' => array(
                ...
                'entity_ID' => array(
                    'type' => 'hidden',
                    'value' => $ses->get('entity_data')[0]['ID'],
                    'label' => 'Entity ID'                    
                ),
		'users_ID' => array(
                    'type' => 'hidden',
