...
class Form_Elements {
    ...
    public static function data($reg, $form_data = NULL) {
        ...
        $FormConfig = array(
             ...
             */
            'form_title' => 'Raw Material Category Master',
            /*
            ...
            'form_content' => array(
                ...
                'RawMaterialType' => array(
                    'filter' => TRUE,
                    'type' => 'text',
                    'value' => $form_data['RawMaterialType'],
                    'label' => 'Raw Material Category',
                    'status'=>'required onblur="Fetch_duplicate_rawmaterial_category_Data('."this.value,'rawmaterialtype','RawMaterialType','RawMaterialType'".')"'
                ...
                'Description' => array(
                    ...
                    'label' => 'Description',
                    'status'=>'onblur="Fetch_duplicate_rawmaterial_category1_Data('."this.value,'rawmaterialtype','Description','Description'".')"'
                ),
                'entity_ID' => array(
                    'type' => 'hidden',
