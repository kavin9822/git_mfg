...
class Form_Elements {
    ...
    public static function data($reg, $form_data = NULL) {
        ...
        $FormConfig = array(
            ...
            'table_name' => 'MaterialRequestMaster',
            /*
            ...
            'form_content' => array(
                ...
                'MaterialRequestNo' => array(
                    'filter' => TRUE,
                    'type' => 'text',
                    'value' => $form_data['MaterialRequestNo'],
                    'label' => 'MaterialRequest Number',
                   
                ),
                'MaterialRequestDate' => array(
                    'filter' => TRUE,
                    'type' => 'text',
                    'value' => $form_data['MaterialRequestDate'],
                    'label' => 'MaterialRequestDate',
                    
                ),
                'MaterialRequestTime' => array(
                    'filter' => TRUE,
                    'type' => 'text',
                    'value' => $form_data['MaterialRequestTime'],
                    'label' => 'MaterialRequestTime'
                ),
                'Area' => array(
                    'filter' => TRUE,
                    'type' => 'text',
