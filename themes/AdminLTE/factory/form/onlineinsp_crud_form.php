...
class Form_Elements {
    ...
    public static function data($reg, $form_data = NULL) {
        ...
        $FormConfig = array(
             ...
             * Title of the Page
             */
            'page_title' => 'Online Inspection',
            /*
             * Can also be the tite of the List data table
             */
            'form_title' => 'Online Inspection',
            /*
            ...
            'form_content' => array(
                ...
                'CoExtruderAmps' => array(
                    'type' => 'text',
                    'value' => $form_data['CoExtruderAmps'],
                    'label' => 'Purchase Order ID'
                ),
                'CorrugatorAmps' => array(
                    'filter' => TRUE,
                    'type' => 'text',
                    'value' => $form_data['CorrugatorAmps'],
                    'label' => 'Batch No'
                ),
                'AuditDateTime' => array(
                    'filter' => TRUE,
