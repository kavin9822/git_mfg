...
class Form_Elements {
    ...
    public static function data($reg, $form_data = NULL) {
        ...
        $FormConfig = array(
            ...
            'form_content' => array(
                ...
                'ProductName' => array(
                    ...
                    'label' => 'Product Name',
                    'status' =>'required onblur="Fetch_duplicate_product_Data('."this.value,'product','ProductName','ProductName'".')"'
                ), 
                 'Description' => array(
                    'filter' =>TRUE,
                    'type' => 'text',
                    ...
                    'status' =>'onblur="Fetch_duplicate_product1_Data('."this.value,'product','Description','Description'".')"'
                ),
                'unit_ID' => array(
                    'filter' => TRUE,
                    'type' => 'selecttwo',
      ...
      //if(!$form_data['AuditVersion']){
         // $auditVersion =  array (
            //'type' => 'hidden',
            //'value' => '1',
         // );
     // $FormConfig["form_content"]['AuditVersion'] = $auditVersion;
     // }elseif($form_data['AuditVersion']){
         // $auditVersion =  array (
           // 'type' => 'hidden',
            //'value' => $form_data['AuditVersion']+1,
        //  );
      //$FormConfig["form_content"]['AuditVersion'] = $auditVersion;
      //}
