...
class Form_Elements {
    ...
    public static function data($reg, $form_data = NULL) {
        ...
        $revenuemodel_tab = $crg->get('table_prefix') . 'revenuemodel';
        $sqlrm = "SELECT `RevenueModel`, `Description` FROM `$revenuemodel_tab`"; 
        $revenue_sel = $dbutil->getSqlData($sqlrm, 12);                
        ...
        $FormConfig = array(
             ...
             */
            'max_number_form_elements_per_colum' => 8,
            /*
