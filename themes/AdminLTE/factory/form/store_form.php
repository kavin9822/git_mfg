        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" name="PurchaseOrderNo" id="PurchaseOrderNo" onchange="$('#BatchNo').val($('#PurchaseOrderNo').find(':selected').data('batchno'));getPPCDetails('<?php echo $home; ?>',this.value);">
