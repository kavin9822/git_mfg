        ...
        $FormConfig = array(
            ...
            'form_content' => array(
                ...
                'DespatchNo' => array(
                    'filter' => TRUE,
                    'type' => 'text',
                    'value' => $form_data['DespatchNo'],
                    'label' => 'Despatch No'
                ),
                'PurchaseEntryDate' => array(
                    'filter' => TRUE,
                    'type' => 'date',
                    'value' => $form_data['PurchaseEntryDate'],
                    'label' => 'PurchaseEntry Date'
                ),
                'PaymentMode' => array(
                    'type' => 'text',
