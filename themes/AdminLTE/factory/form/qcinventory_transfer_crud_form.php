...
class Form_Elements {
    ...
    public static function data($reg, $form_data = NULL) {
        ...
        $FormConfig = array(
            ...
            'table_name' => 'qc_inventory_transfer',
            /*
          ...
          //  'unique_key_suffix_from_column_name' => 'Country',
             ...
             * Title of the Page
             */
            'page_title' => 'Qc Inventory Transfer',
            /*
            ...
            'from_warehouse' => array(
                    'filter' => TRUE,
                    'type' => 'select',
                    'value' => $form_data['from_warehouse'],
            ...
            'to_warehouse' => array(
                    'filter' => TRUE,
                    'type' => 'select',
                    'value' => $form_data['to_warehouse'],
                    'label' => 'To Warehouse'

                
            ),
			// 	'Purchase_Indent_No' => array(
            //         'filter' => TRUE,
            //         'type' => 'select',
            //         'value' => $form_data['Purchase_Indent_No'],
