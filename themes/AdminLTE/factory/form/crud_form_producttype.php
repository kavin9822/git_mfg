        ...
        $FormConfig = array(
            ...
            'form_content' => array(
                ...
                'ProductType' => array(
                    'filter' => TRUE,
                    'type' => 'text',
                    'value' => $form_data['ProductType'],
                    'label' => 'Product Category',
                    'status'=>'required onblur="Fetch_duplicate_productcategory_Data('."this.value,'producttype','ProductType','ProductType'".')"'
                ),
                'Description' => array(
                    'filter' => TRUE,
                    'type' => 'text',
                    ...
                    'label' => 'Description',
                    'status'=>'onblur="Fetch_duplicate_productcategory1_Data('."this.value,'producttype','Description','Description'".')"'
                ),
                'entity_ID' => array(
                    'type' => 'hidden',
