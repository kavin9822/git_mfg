        ...
        <div class="row">
            <div class="col-xs-12">
                <h2 class="page-header">
                    <img src="<?php echo $invoice_logo; ?>" class="img" alt="Invoice Logo"><?php echo "  "?>
                    <?php echo $page_title; ?>
        ...
        <div class="row">
            <div class="col-md-6"> 
               ...
               <div class="form-group">
                                    <label for="InvoiceFor" class="col-sm-3 control-label">Choose Invoice For</label>
                                    <div class="col-sm-9">
                                        <input <?php if($FmData['InvoiceFor'] === 'Customer'){echo 'checked';}?> id="InvoiceFor" name="InvoiceFor" type="radio" onclick="$('#customer_ID').attr('disabled',false);$('#buyer_ID').attr('disabled',true);">Customer
                                        <input <?php if($FmData['InvoiceFor'] === 'Buyer'){echo 'checked';}?> id="InvoiceFor" name="InvoiceFor" type="radio" onclick="$('#customer_ID').attr('disabled',true);$('#buyer_ID').attr('disabled',false);">Buyer        
                                    </div>
               </div>
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                    <label for="buyer_ID" class="col-sm-3 control-label">Buyer ID</label>
                    <div class="col-sm-9">
                        <select class="form-control" name="buyer_ID" id="buyer_ID">
                            <?php foreach ($buyer_data as $buy_opt_key => $buy_opt_value): ?>
                                <option  value="<?php echo $buy_opt_key; ?>" title="<?php echo $buy_opt_value; ?>"><?php echo $buy_opt_value; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                    ...
                    <tbody id="invoice_listing_table">
                        ...
                        <tr id="Invoice_data_entry_1">
                            ...
                            <td>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <input class="form-control" id="Description_1" name="Description_1" value="" placeholder="Note" type="text">
                                    </div>
                                </div>
                            </td>
