...
class Form_Elements {
    ...
    public static function data($reg, $form_data = NULL) {
        ...
        $FormConfig = array(
            ...
            'table_name' => 'materialissue_consumables',
            /*
          ...
          //  'unique_key_suffix_from_column_name' => 'Country',
            ...
            'ID' => array(
             ...
             'con_materialissue_no' => array(
                    'filter' => TRUE,
                    'type' => 'text',
                    'value' => $form_data['con_materialissue_no'],
                    'label' => 'Consumable Material Issue No'
                    
                
            ),   
            'con_materialrequest_no' => array(
                    'filter' => TRUE,
                    'type' => 'select',
                    'value' => $form_data['con_materialrequest_no'],
                    'label' => 'Consumable Material Request No'
