			...
			<input id="ycs_ID" name="ycs_ID" value="<?php if($ycs_ID){echo $ycs_ID;}?>"  type="hidden">
                <div class="col-lg-6">
		            <div class="form-group">
                       <label  class="col-sm-3 control-label">Consumable Material Req No</label>
			           <div class="col-sm-9">
                            <input class="form-control" id="Reqno" name="Reqno" value="<?php if(isset($FmData[0]['Reqno'])){echo $FmData[0]['Reqno'];}else{echo $Reqno;}?>" type="text" readonly>
			          </div>
		          </div>
                  <div class="form-group">
                ...
                <table class="table table-striped">
                    ...
                    <tbody id="invoice_listing_table">
                            ...
                            <tr id="Invoice_data_entry_<?php echo $tii; ?>">
                                ...
                                <td>                                      
                                    <div class="form-group">
                                         <select class="form-control" name="Field2_<?php echo $tii; ?>" id="Field2_<?php echo $tii; ?>" onchange="SqlbasedSelectdetail(this.value,this.id,'unit_','unit','rawmaterial','UnitName','unit_ID','rawmaterial');validateExist(this.id,'invoice_listing_table');" required>
                                               <option value="" disabled selected style="display:none;">Select</option>
								...
								<td>                                      
                                    <div class="form-group">
									    ...
									    value="<?php if(isset($dataValue['Quantity'])){ echo $dataValue['Quantity']; } ?>" placeholder="Enter Quantity" onkeypress="return onlyNumbernodecimal(event);" required>
                                        </div>
                                    </div>
                                </td>
                                <td>                                      
                            ...
                            <td>                                      
                                <div class="form-group">
                                    <div class="col-sm-12">
                                    <select class="form-control" name="Field2_1" id="Field2_1" onchange="SqlbasedSelectdetail(this.value,this.id,'unit_','unit','rawmaterial','UnitName','unit_ID','rawmaterial');validateExist(this.id,'invoice_listing_table');" required>
                                            <option value="" disabled selected style="display:none;">Select</option>
                                            <?php foreach($rawmaterial_data as $k => $v): ?>
							...
							<td>                                      
                                <div class="form-group">
                                    <div class="col-sm-12">
                                         <input class="form-control" type="text" id="Field3_1" name="Field3_1" value="" placeholder="Enter Quantity" onkeypress="return onlyNumbernodecimal(event);" required>
                                    </div>
         	                    </div>
                            </td>
                            <td>                                      
