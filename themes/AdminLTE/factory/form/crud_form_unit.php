        ...
        $FormConfig = array(
            ...
            'form_content' => array(
                ...
                'UnitName' => array(
                    ...
                    'label' => 'Unit Name',
                    'status'=>'required onblur="Fetch_duplicate_unit_Data('."this.value,'unit','UnitName','UnitName'".')"'
                ),
                'Description' => array(
                    'filter' => TRUE,
                    'type' => 'text',
                    ...
                    'label' => 'Description',
                    'status'=>'onblur="Fetch_duplicate_unit1_Data('."this.value,'unit','Description','Description'".')"'
                ),
            ),
            'form_footer' => array(
                'clear' => array(
