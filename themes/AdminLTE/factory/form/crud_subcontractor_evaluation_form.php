...
class Form_Elements {
    ...
    public static function data($reg, $form_data = NULL) {
        ...
        $FormConfig = array(
            ...
            'table_name' => 'subcontractor_evaluation',
            /*
             ...
             * Title of the Page
             */
            'page_title' => 'Subcontractor Evaluation And Assessment',
            /*
             * Can also be the tite of the List data table
             */
            'form_title' => 'Subcontractor Evaluation And Assessment',
            /*
