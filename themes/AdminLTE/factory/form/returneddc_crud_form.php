...
class Form_Elements {
    ...
    public static function data($reg, $form_data = NULL) {
        ...
        $sql_customer = "SELECT `ID`,`FirstName` FROM `$customer_table`";
        $customer_select = $dbutil->getSqlData($sql_customer, 12);
        ...
        $FormConfig = array(
             ...
             */
            'form_title' => 'Returned Delivery Challan', 
            /*
            ...
            'form_content' => array(
                ...
                'PurchaseOrderNo' => array(
                    'filter' => FALSE,
                    'type' => 'hidden',
                    'value' => $form_data['PurchaseOrderNo'],
                ...
                'PurchaseOrderDate' => array(
                    'filter' => TRUE,
                    'type' => 'date',
                    'value' => $form_data['PurchaseOrderDate'],
                    'label' => 'PurchaseOrder Date'
                ),
                'PaymentMode' => array(
                    'type' => 'text',
                ...
                'TermsOfDelivery' => array(
                    'type' => 'text',
                    'value' => $form_data['TermsOfDelivery'],
