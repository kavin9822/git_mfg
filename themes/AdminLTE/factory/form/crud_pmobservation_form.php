...
class Form_Elements {
    ...
    public static function data($reg, $form_data = NULL) {
        ...
        $FormConfig = array(
            ...
            'table_name' => 'PMObservationMaster',
            /*
             ...
             * Title of the Page
             */
            'page_title' => 'Preventive Maintenance Observation',
            /*
            ...
            'form_content' => array(
                ...
                'pmchecklistmaster_ID' => array(
                    'filter' => TRUE,
                    'type' => 'text',
                    'value' => $form_data['pmchecklistmaster_ID'],
                    'label' => 'PMCheckListMaster Name',
