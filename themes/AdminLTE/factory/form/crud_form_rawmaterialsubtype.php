...
class Form_Elements {
    ...
    public static function data($reg, $form_data = NULL) {
        ...
        $FormConfig = array(
             ...
             */
            'form_title' => 'Raw Material SubCategory Master',
            /*
            ...
            'form_content' => array(
                ...
                'RawMaterialSubType' => array(
                    'filter' => TRUE,
                    'type' => 'text',
                    'value' => $form_data['RawMaterialSubType'],
                    'label' => 'Raw Material SubType',
                    'status'=>'required onblur="Fetch_duplicate_rawmaterial_subcategory_Data('."this.value,'rawmaterialsubtype','RawMaterialSubType','RawMaterialSubType'".')"'
                ...
                'Description' => array(
                    ...
                    'label' => 'Description',
                    'status'=>'onblur="Fetch_duplicate_rawmaterial_subcategory1_Data('."this.value,'rawmaterialsubtype','Description','Description'".')"'
                ),
                'entity_ID' => array(
                    'type' => 'hidden',
