...
class Form_Elements {
    ...
    public static function data($reg, $form_data = NULL) {
        ...
        $FormConfig = array(
            ...
            'table_name' => 'MaterialIssueMaster',
            /*
             ...
             */
            'max_number_form_elements_per_colum' =>25,
            /*
            ...
            'form_content' => array(
                ...
                'MaterialIssueNo' => array(
                    'filter' => TRUE,
                    'type' => 'text',
                    'value' => $form_data['MaterialRequestNo'],
                    'label' => 'MaterialIssue No',
                ...
                'MaterialIssueDate' => array(
                    'filter' => TRUE,
                    'type' => 'text',
                    'value' => $form_data['MaterialIssueDate'],
                    'label' => 'MaterialIssueDate',
                    
                ),
                'MaterialIssueTime' => array(
                    'filter' => TRUE,
                    'type' => 'text',
                    'value' => $form_data['MaterialRequestTime'],
                    'label' => 'MaterialIssueTime'
                ),
                'Area' => array(
                    'filter' => TRUE,
                    'type' => 'text',
