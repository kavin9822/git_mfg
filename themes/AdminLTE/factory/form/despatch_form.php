<section class="invoice">
    <form class="form-horizontal" id="crud_form" action="<?php echo $home . '/' . $module . '/' . $controller . '/' . $method; ?>/submit/" method="post">  
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" name="PurchaseOrderNo" id="PurchaseOrderNo" onchange="$('#BatchNo').val($('#PurchaseOrderNo').find(':selected').data('batchno'));getManufDetailsDes('<?php echo $home; ?>',this.value);">
        ...
        <!-- /.header part  -->
        <h5><u>Manufacturing Detail</u></h5>
        <div class="box-body">
                    ...
                    <!--        </tr>-->
                            ...
                            <tr>
                                ...
                                <th><span id="Total"></span>
                                    ...
                                    <input type="hidden" name="STotal" id="STotal" value="">
                                </th>
                            </tr>
                        </tbody></table>
                </div>
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                ...
                <button type ="submit" class="btn btn-success pull-right margin" onmouseover='subtotal_desp()' onfocus='subtotal_desp()'> Submit</button>
            </div>
        </div>
    </form>
