...
class Form_Elements {
    ...
    public static function data($reg, $form_data = NULL) {
        ...
        $FormConfig = array(
            ...
            'table_name' => 'customercomplaint_register',
            /*
             ...
             * Title of the Page
             */
            'page_title' => 'Customer Complaint Register',
            /*
             * Can also be the tite of the List data table
             */
            'form_title' => 'Customer Complaint Register',
            /*
            ...
            'form_content' => array(
				...
				'CustomerID' => array(
                    'filter' => TRUE,
                    'type' => 'select',
                    'value' => $form_data['CustomerID'],
                    'label' => 'Customer Name'
                ),
				'CustomerOrderDetail_ID' => array(
                    'filter' => TRUE,
                    'type' => 'select',
                    'value' => $form_data['CustomerOrderDetail_ID'],
                    'label' => 'Product Name'
                ),
                'entity_ID' => array(
                    'type' => 'hidden',
