  ...
  <body class="hold-transition login-page" onload="checkCookie()">
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <form action="<?php echo $home.'/'.$module.'/'.$controller .'/login'; ?>" method="post">
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
                <button type="submit" name = "login_submit" value="submit" onclick="toggle()" class="btn btn-primary btn-block btn-flat">Sign In</button>
            </div><!-- /.col -->
          </div>
        </form>        
        
        <a href="<?php echo $home.'/'.$module.'/'.$controller .'/forgegtPassword'; ?>">I forgot my password</a><br>
        <!--<a href="<?php echo $home.'/'.$module.'/'.$controller .'/register'; ?>" class="text-center">Register a new membership</a><br><br>-->
