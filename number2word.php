...
//echo $f->format(130000);


//$amount = '130000';
//setlocale(LC_MONETARY, 'en_IN');
//$amount = money_format('%!i', $amount);
//echo $amount;NumberFormatter::CURRENCY_SYMBOL

//$f = new NumberFormatter("en_IN", NumberFormatter::SPELLOUT);
//$f = new NumberFormatter("IN", NumberFormatter::CURRENCY_SYMBOL);
...
echo getIndianCurrency(513555000) . ' only';