...
/////////////////////////////////////////
    ...
    protected function sgChangeUserStatus() {
      ...
      //var_dump($_POST);
	   ...
	   $u_SGServerIP = $this->ses->get('entity_data')[0]['SGServerIP'];
            ...
            if ($responceData) {
			    ...
			    $cus_nam_arr = preg_split("/[\s]+/",$cus_name);	
                        ...
                        if (!empty($CustomerMobileNo) && preg_match('/^\d{10}$/', $CustomerMobileNo)) {                           
                            ...
                            $smsMessage = 'Dear+' . $cust_fname . '!.+Ur+package+is+changed+to+"' . $cust_pack . '"+on+' . date("j+M+Y+g:i+a");
