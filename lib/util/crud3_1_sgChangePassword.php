...
/////////////////////////////////////////
    ...
    protected function sgChangePw() {
//name="ycs_ID"
      
        $yid = $_POST['ID'];
        $ySGpassword = trim($_POST['SGpassword']);
        ...
        if ( $rowData['SGloginID'] !== '' && $rowData['SGloginID'] !== NULL && $rowData['SGpassword'] !== $ySGpassword ) {
...
////////////////////////////////////////////
            ...
            $url .= "&old_password=" . $rowData['SGpassword'];
            $url .= "&new_password=" . $ySGpassword;
...
/////////////////////////////
            ...
            if ($responceData) {
                ...
                //over right with quote
               $ySGpasswordQuote = $this->db->quote($ySGpassword);


                switch ($responcedataArr[0]) {
                    case 'Status:Success':
                      $sql = "UPDATE $table1 SET $table1.SGpassword = $ySGpasswordQuote  WHERE $table1.ID = $yid";

                            $stmt = $this->db->prepare($sql);
                            if($stmt->execute()){
                            	$this->tpl->set('message', $responcedataArr[1] . 'SGuserRegStatus Update Successfull');
                            }else{
                            	//if failed to update local machine revert the update in smartgard
                            	///////////////////////////////////////////////////////////////
		...
		////////////////////////////////////////////
            ...
            $url .= "&authkey=sguregp";
            $url .= "&login_id=" . $rowData['SGloginID'];
            $url .= "&old_password=" . $ySGpassword;
            $url .= "&new_password=" . $rowData['SGpassword'];
		...
		$this->tpl->set('message', $responcedataArr[1] . 'But SG update revert Failed, Try Again');
            }
                            	
                            ///////////////////////////////////////////////////////////////////////
	                	$this->tpl->set('message', $responcedataArr[1] . 'But SG update reverted, Try Again');
                            }
                        break;
                    case 'Status:Failed':
            ...
            $this->tpl->set('message', 'No change in password');
        }
