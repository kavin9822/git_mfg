...
if($_POST["ColumnValue"]){
   ...
   // var_dump($tablename);
    ...
    $wheretab_name = $tablePrefix .$wheretable;
       ...
       $sql_query="SELECT $firsttab_name.ID,$selectcolumnname FROM $firsttab_name LEFT JOIN $secondtab_name ON $firsttab_name.$selectid=$secondtab_name.ID WHERE $wheretab_name.$joinid='".$_POST['ColumnValue']."'";
