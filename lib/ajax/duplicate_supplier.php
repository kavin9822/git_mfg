...
if($_POST["ColumnValue"]){
    ...
    $sql_query ="SELECT $supplier_table.SupplierName FROM $supplier_table WHERE $supplier_table.SupplierName='".$_POST['ColumnValue']."' AND $supplier_table.SupplierType='".$_POST['Supplier_type']."'";
