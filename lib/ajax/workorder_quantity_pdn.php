...
if($_POST["ColumnValue"]){
  if($_POST["Processid"]){
    ...
    $sql_query ="SELECT $workorder_table.StartingProductionNo,$workorder_table.EndProdNo FROM $workorder_table WHERE $workorder_table.ProcessID='".$_POST['Processid']."' AND $workorder_table.product_ID='".$_POST['productID']."'";
