...
if($_POST["ColumnValue"]){
  ...
  $customerorder_table = $tablePrefix . 'customerorder';
    ...
    $sql_query ="SELECT CONCAT(GF_or_Roving,' ',ResinType) as seq,$customerorder_table.ResinType FROM $customerorder_table WHERE $customerorder_table.enquiry_ID=".$_POST['ColumnValue']."";
