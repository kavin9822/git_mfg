...
if(!empty($_POST["CountryVal"])){
    ...
    $sql_query  = "SELECT $country_tab.ID,$country_tab.CountryName FROM $country_tab WHERE $country_tab.ID=".$_POST['CountryVal']."";
}else{
     $sql_query  = "SELECT $country_tab.ID,$country_tab.CountryName FROM $country_tab";
}
    	try {
