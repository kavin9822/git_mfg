...
if($_POST["producttype_id"]){
    ...
    //$entityID = $ajxSess->get('user')['entity_ID'];
      ...
      $sql_query ="SELECT $product_table.Description FROM $product_table WHERE $product_table.Description='".$_POST['ColumnValue']."' AND $product_table.producttype_ID='".$_POST['producttype_id']."'";
