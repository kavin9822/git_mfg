...
if($_POST["ColumnValue"]){
    ...
    $sql_query ="SELECT $supplier_table.ID,$supplier_table.ContactPerson,$supplier_table.ContactNumber,$supplier_table.AddressLine1 FROM $supplier_table WHERE $supplier_table.ID=".$_POST['ColumnValue']."";
