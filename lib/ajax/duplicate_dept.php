...
if($_POST["ColumnValue"]){
	...
	$department_table = $tablePrefix . 'department';
   
    
    $entityID = $ajxSess->get('user')['entity_ID'];
    
  
    $sql_query ="SELECT $department_table.DeptName FROM $department_table WHERE $department_table.DeptName='".$_POST['ColumnValue']."'";
