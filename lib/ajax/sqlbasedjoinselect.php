...
if($_POST["ColumnValue"]){
   ...
   // var_dump($tablename);
    ...
    $wheretab_name = $tablePrefix .$wheretable;
         ...
         $sql_query="SELECT $secondtab_name.ID,$selectcolumnname FROM $firsttab_name,$secondtab_name  WHERE $secondtab_name.$selectid = $firsttab_name.ID and $secondtab_name.$selectid ='".$_POST['ColumnValue']."'";
       // $sql_query="SELECT $secondtab_name.ID,$selectcolumnname FROM $firsttab_name,$secondtab_name  WHERE $firsttab_name.$selectid = $secondtab_name.ID and $wheretab_name.ID='".$_POST['ColumnValue']."'";
