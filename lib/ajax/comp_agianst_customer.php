...
if($_POST["ColumnValue"]){
    ...
    $customerid=trim($_POST['ColumnValue']);
  

     $sql_query ="SELECT $customer_tab.ID,$customer_tab.PersonName,
                         ...
                         LEFT JOIN $country_tab ON $customer_tab.BillingCountry_ID=$country_tab.ID  WHERE $customer_tab.ID='$customerid'";
