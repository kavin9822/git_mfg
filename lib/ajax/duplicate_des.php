...
if($_POST["Department_id"]){
	...
	$designation_table = $tablePrefix . 'designation';
   
    
    //$entityID = $ajxSess->get('user')['entity_ID'];
    
  
      $sql_query ="SELECT *,$designation_table.DesignationName FROM $designation_table WHERE $designation_table.DesignationName='".$_POST['ColumnValue']."' AND $designation_table.Department_ID='".$_POST['Department_id']."'";
