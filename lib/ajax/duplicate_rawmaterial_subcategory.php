...
if($_POST["rawmaterialtype_id"]){
    ...
    //$entityID = $ajxSess->get('user')['entity_ID'];
      ...
      $sql_query ="SELECT $rawmaterialsubtype_table.RawMaterialSubType FROM $rawmaterialsubtype_table WHERE $rawmaterialsubtype_table.RawMaterialSubType='".$_POST['ColumnValue']."' AND $rawmaterialsubtype_table.rawmaterialtype_ID='".$_POST['rawmaterialtype_id']."'";
