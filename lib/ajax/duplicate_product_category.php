...
if($_POST["ColumnValue"]){
	...
	$producttype_table = $tablePrefix . 'producttype';
   
    
    $entityID = $ajxSess->get('user')['entity_ID'];
    
  
    $sql_query ="SELECT $producttype_table.ProductType FROM $producttype_table WHERE $producttype_table.ProductType='".$_POST['ColumnValue']."'";
