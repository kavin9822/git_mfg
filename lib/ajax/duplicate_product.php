...
if($_POST["producttype_id"]){
    ...
    //$entityID = $ajxSess->get('user')['entity_ID'];
      ...
      $sql_query ="SELECT $product_table.ProductName FROM $product_table WHERE $product_table.ProductName='".$_POST['ColumnValue']."' AND $product_table.producttype_ID='".$_POST['producttype_id']."'";
