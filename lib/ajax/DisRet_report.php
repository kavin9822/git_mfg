...
if($_POST["ProductionID"]){
    ...
    $sql_query ="SELECT $product_table.ID,$product_table.ProductName FROM $product_table 
                 LEFT JOIN $dispatchreturnable_table ON $dispatchreturnable_table.product_ID=$product_table.ID 
                 WHERE $dispatchreturnable_table.ProductionID=".$_POST['ProductionID']." GROUP BY $product_table.ProductName";
